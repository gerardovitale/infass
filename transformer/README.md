...
| `price_var_abs`          | `float32`        | Absolute variation in price.                      |
| `price_var_%`            | `float32`        | Percentage variation in price.                    |
| `original_price_var_abs` | `float32`        | Absolute variation in original price.             |
| `original_price_var_%`   | `float32`        | Percentage variation in original price.           |
