...
class TestBucketReader(BasicTestCase):
    ...
    def setUp(self):
        ...
        storage_client_patch = patch(f"{TEST_MODULE}.storage.Client")
        self.addCleanup(storage_client_patch.stop)
        self.mock_storage_client = storage_client_patch.start()
    ...
    def test_read_csv_as_pd_df_should_return_last_object_when_limit_is_minus_1(self):
        ...
        limit = -1
        self.mock_list_blobs.return_value = (MockBlob(f"2025-01-0{day}.csv", "mock_content") for day in range(1, 5))
    ...
    def test_read_csv_as_pd_df_should_return_all_objects_when_limit_is_none(self):
        test_bucket_name = "test_bucket_name"
        self.mock_list_blobs.return_value = (MockBlob(f"2025-01-0{day}.csv", "mock_content") for day in range(1, 4))
        self.mock_read_blobs.return_value = "col1,col2,col3\n1,2,3\n1,2,3\n1,2,3"
    ...
    def test_read_csv_as_pd_df_should_return_n_objects_when_limit_is_n(self):
        test_bucket_name = "test_bucket_name"
        limit = 2
        self.mock_list_blobs.return_value = (MockBlob(f"2025-01-0{day}.csv", "mock_content") for day in range(1, 8))
        self.mock_read_blobs.return_value = "col1,col2,col3\n1,2,3\n1,2,3\n1,2,3"
